...
export const CONSTELLATION_PATTERNS: ConstellationPattern[] = [
  // Quality Assurance Circuit
  {
    ...
    starIds: ['output-calibration', 'radiation-therapy', 'treatment-planning'],
  ...
  // ALARA Principle Triangle
  {
    ...
    starIds: ['radiation-dosimetry', 'treatment-planning', 'patient-positioning'],
    connectionIds: [],
    discovered: false,
    formation: 'triangle',
    reward: {
  ...
  // Treatment Planning Cascade
  {
    ...
    starIds: ['treatment-planning', 'radiation-therapy', 'delivery-techniques', 'treatment-protocols'],
    connectionIds: [],
    discovered: false,
    formation: 'chain',
    reward: {
  ...
  // Beam Delivery Precision Star
  {
    ...
    starIds: ['radiation-therapy', 'delivery-techniques', 'output-calibration'],
    connectionIds: [],
    discovered: false,
    formation: 'star',
    reward: {
  ...
  // Plan Optimization Diamond
  {
    ...
    starIds: ['treatment-planning', 'radiation-therapy', 'output-calibration', 'radiation-dosimetry'],
    connectionIds: [],
    discovered: false,
    formation: 'circuit',
    reward: {
